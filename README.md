...
Blink an LED connected to GPIO17 for 5 seconds using synchronous readSync and
writeSync methods.
...
Blink an LED connected to GPIO17 for 5 seconds using asynchronous read and
